...
#[case("in", Ok(vec![LexKind::Normal(Token::In)]))]
...
#[case("=>", Ok(vec![LexKind::Normal(Token::FatArrow)]))]
...
#[case("[[", Ok(vec![LexKind::Brace(Brace::DoubleSquare, BraceDirection::Open)]))]
#[case("]]", Ok(vec![LexKind::Brace(Brace::DoubleSquare, BraceDirection::Close)]))]
#[case("[ [", Ok(vec![LexKind::Brace(Brace::Square, BraceDirection::Open), LexKind::Whitespace(1), LexKind::Brace(Brace::Square, BraceDirection::Open)]))]
#[case("] ]", Ok(vec![LexKind::Brace(Brace::Square, BraceDirection::Close), LexKind::Whitespace(1), LexKind::Brace(Brace::Square, BraceDirection::Close)]))]
