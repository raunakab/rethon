...
// use aggregator::{Brace, BraceDirection, Token, TokenType, aggregator as
// aggregate_tokens}; use thiserror::Error;
...
//     #[error("Mismatched closing brace: expected {expected:?}, found {found:?}
// at byte {position}")]     MismatchedBrace {
//         expected: Brace,
//         found: Brace,
//         position: usize,
//     },
