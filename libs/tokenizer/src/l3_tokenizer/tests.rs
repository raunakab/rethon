use lexer::{Brace, BraceDirection, LexType, lex};
...
#[rstest::rstest]
#[case("", Ok(vec![]))]
#[case("fn", Ok(vec![n(LexType::Function, 0, 0)]))]
#[case("fn add", Ok(vec![
    n(LexType::Function, 0, 0),
    n(LexType::Identifier("add"), 0, 0),
]))]
#[case("fn add\nreturn", Ok(vec![
    n(LexType::Function, 0, 0),
    n(LexType::Identifier("add"), 0, 0),
    n(LexType::Return, 1, 0),
]))]
#[case("fn\n    add", Ok(vec![
    n(LexType::Function, 0, 0),
    n(LexType::Identifier("add"), 1, 1),
]))]
#[case("fn\n    if\n        x", Ok(vec![
    n(LexType::Function, 0, 0),
    n(LexType::If, 1, 1),
    n(LexType::Identifier("x"), 2, 2),
]))]
#[case("fn\n    x\ny", Ok(vec![
    n(LexType::Function, 0, 0),
    n(LexType::Identifier("x"), 1, 1),
    n(LexType::Identifier("y"), 2, 0),
]))]
#[case("a\n    x\n    y", Ok(vec![
    n(LexType::Identifier("a"), 0, 0),
    n(LexType::Identifier("x"), 1, 1),
    n(LexType::Identifier("y"), 2, 1),
]))]
#[case("fn\n    if\n        x\n        y\n    else\n        z", Ok(vec![
    n(LexType::Function, 0, 0),
    n(LexType::If, 1, 1),
    n(LexType::Identifier("x"), 2, 2),
    n(LexType::Identifier("y"), 3, 2),
    n(LexType::Else, 4, 1),
    n(LexType::Identifier("z"), 5, 2),
]))]
#[case("a\n    b\n        c\n            d", Ok(vec![
    n(LexType::Identifier("a"), 0, 0),
    n(LexType::Identifier("b"), 1, 1),
    n(LexType::Identifier("c"), 2, 2),
    n(LexType::Identifier("d"), 3, 3),
]))]
#[case("fn\r\n    add", Ok(vec![
    n(LexType::Function, 0, 0),
    n(LexType::Identifier("add"), 1, 1),
